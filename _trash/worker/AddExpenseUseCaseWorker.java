...
import com.kartaguez.bluepot.application.usecases.dto.AddExpenseDtoIn;
import com.kartaguez.bluepot.application.usecases.dto.AddExpenseDtoOut;
import com.kartaguez.bluepot.application.usecases.mapper.AddExpenseDtoOutMapper;
...
public class AddExpenseUseCaseWorker {
    ...
    private AddExpenseUseCaseWorker createExpense() {
        ...
        this.pot = this.potRepository.loadPotByUuid(UUID.fromString(this.addExpenseDtoIn.getExpenseDto().getPotUuid()), Constants.NULL_VERSION);
