...
public class PotShareholderUTest {
    ...
    public void create_PotShareholder_with_potUuid_and_name_OK() {
        ...
        PotShareholder potShareholder = PotShareholder.builder(potShareholderUuid, potShareholderName).build();
    ...
    public void create_PotShareholder_with_null_uuid_KO() {
        ...
        String potShareholderName = "Alex";
        assertThrows(IllegalArgumentException.class, () -> PotShareholder.builder(potShareholderUuid, potShareholderName));
    }
