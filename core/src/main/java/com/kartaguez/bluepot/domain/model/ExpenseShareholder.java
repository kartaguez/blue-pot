...
public class ExpenseShareholder extends VersionedObject {
    ...
    public static ExpenseShareholder hydrateRoot(String _uuid, @NonNull String _expenseUuid, @NonNull String _potShareholderUuid,  long _targetGlobalVersion, long _createdAtVersion, long _deletedAtVersion, @NonNull String _weight) {
        UUID hUuid = null;
        if (null != _uuid) {
            hUuid = UUID.fromString(_uuid);
        }
        return new ExpenseShareholder(hUuid, UUID.fromString(_expenseUuid), UUID.fromString(_potShareholderUuid), _targetGlobalVersion, _createdAtVersion, _deletedAtVersion, Fraction.getFraction(_weight));
    }

    public static ExpenseShareholderMutationResultSet createRoot(@NonNull UUID _expenseUuid, @NonNull UUID _potShareholderUuid, long _targetGlobalVersion, @NonNull Fraction _weight) {
    ...
    public ExpenseShareholderMutationResultSet updateRoot(long _targetGlobalVersion, @NonNull Fraction _weight) {
        if (Fraction.ZERO.equals(_weight)) {
            throw new IllegalArgumentException("Expense Shareholder weight cannot be 0.");
        }
        this.markAsDeleted();
