...
public class ExpenseShareholderDtoMapper {
    ...
    public static ExpenseShareholderDto toDto(@NonNull ExpenseShareholder expenseShareholder) {
        String tUuid = null;
    ...
    public static HashMap<UUID, Fraction> fromListToHashMap(@NonNull List<ExpenseShareholderDto> expenseShareholderDtos) {
    ...
    public static List<ExpenseShareholderDto> fromHashMapToList(@NonNull HashMap<UUID, ExpenseShareholder> expenseShareholders) {

        ArrayList<ExpenseShareholderDto> expenseShareholderDtos = new ArrayList<ExpenseShareholderDto>();
        expenseShareholders.values().stream().forEach(potShareholderDto -> expenseShareholderDtos.add(ExpenseShareholderDtoMapper.toDto(potShareholderDto)));
