...
public class Pot extends VersionedObject {
    ...
    public Pot(@NonNull UUID _uuid, long _targetGlobalVersion, long _createdAtVersion, long _deletedAtVersion, @NonNull String _name, HashMap<UUID, PotShareholder> _potShareholders, HashMap<UUID, Expense> _expenses) {
        this.uuid = _uuid;
    ...
    public static PotMutationResultSet create(@NonNull String _name) {
    ...
    public PotMutationResultSet rename(@NonNull String _name) {
        if (this.isDeleted()) {
    ...
    public ExpenseMutationResultSet addExpense(@NonNull UUID payerUuid, @NonNull HashMap<UUID, Fraction> payeeWeights, @NonNull Fraction amount, @NonNull String label) {
        ...
        ExpenseMutationResultSet expenseMutationResultSet = Expense.create(this.uuid, this.targetGlobalVersion, payerUuid, amount, label);
    ...
    public ExpenseMutationResultSet updateExpense(@NonNull UUID expenseUuid, UUID payerUuid, HashMap<UUID, Fraction> payeeWeights, Fraction amount, String label) {
        ...
        ExpenseMutationResultSet expenseMutationResultSet = expense.update(payerUuid, amount, label);
